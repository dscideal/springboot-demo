...
public class ConstVal {
    ...
    public static final String MSSERIVCE = "msService";
    public static final String SERVICEIMPL = "ServiceImpl";
    public static final String MAPPER = "Mapper";
    public static final String XML = "Xml";
    public static final String CONTROLLER = "Controller";
    public static final String MSCONTROLLER = "msController";
    ...
    public static final String TEMPLATE_MSSERVICE = "/templates/msService.java.vm";
    ...
    public static final String TEMPLATE_MSCONTROLLER = "/templates/msController.java.vm";
