...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.MSCONTROLLER, joinPackage(config.getParent(), "msController"));//mscontroller
        packageInfo.put(ConstVal.MSSERIVCE, joinPackage(config.getParent(), "msService"));// msservice
        // 生成路径信息
