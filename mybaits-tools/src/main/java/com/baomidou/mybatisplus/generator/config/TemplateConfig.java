...
public class TemplateConfig {
    ...
    private String msController = ConstVal.TEMPLATE_MSCONTROLLER;

    private String msService = ConstVal.TEMPLATE_MSSERVICE;

    public String getMsController() {
        return msController;
    }

    public void setMsController(String msController) {
