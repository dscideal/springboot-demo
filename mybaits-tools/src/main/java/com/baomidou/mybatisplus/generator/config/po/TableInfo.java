...
public class TableInfo {
    ...
    private String serviceField;// stock
    private String serviceFieldU;// Stock
    private String mapperName;
    private String xmlName;
    private String serviceName;
    private String serviceImplName;
    private String controllerName;
    private String mscontrollerName;
    ...
    private String fieldNames;// 字段与属性(驼峰)
    ...
    public String getMscontrollerName() {
        return mscontrollerName;
    }

    public void setMscontrollerName(String mscontrollerName) {
        this.mscontrollerName = mscontrollerName;
    }
    ...
    public void setEntityName(StrategyConfig strategyConfig, String entityName) {
        this.entityName = moveFirstStr(entityName);
        String s = this.entityName;
        this.entityNameField = (new StringBuilder()).append(Character.toLowerCase(s.charAt(0))).append(s.substring(1)).toString();
        this.serviceField = strArr(this.entityName).get(0);
        this.serviceFieldU = upperCase(this.serviceField);
        this.setConvert(strategyConfig);
    }

    public String getServiceFieldU() {
        return serviceFieldU;
    }

    public void setServiceFieldU(String serviceFieldU) {
        this.serviceFieldU = serviceFieldU;
    }
    ...
    public void setServiceName(String serviceName) {
        this.serviceName = serviceName.substring(1,serviceName.length());
    }
    ...
    // 去字符串(驼峰) 的每个单词
    public static List<String>  strArr(String str){
        List<String> rs = new ArrayList<String>();
        int index = 0;
        int len = str.length();
        for (int i = 1; i < len; i++) {
            if (Character.isUpperCase(str.charAt(i))) {
                rs.add(str.substring(index, i).toLowerCase());
                index = i;
            }
        }
  ...
  public String upperCase(String str) {
    ...
    public String moveFirstStr(String entityName){
        if(entityName!=null && !entityName.equals("")){
            if(entityName.startsWith("T")){
